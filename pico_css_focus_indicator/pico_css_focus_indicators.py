...
def create_main():
    return Main(
        ...
        P('So when we discovered that a silly little file containing subscriber names, card details, and maybe some biometric hints had wandered onto the open internet, we thought: "Time to make some lemonade!"'),
